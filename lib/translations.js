...
export const translations = {
  ru: {
    ...
    cabinet: {
      ...
      login: {
        ...
        subtitle: 'Управляйте вашими базами 1С, тарифом и счетами.',
        email: 'E-mail',
        password: 'Пароль',
        submit: 'Войти',
        sending: 'Входим…',
      ...
      dashboard: {
        ...
        subtitle: 'Краткая сводка по вашему облаку 1С.',
        ...
        users: 'Пользователей',
        storage: 'Хранилище',
        unpaidTitle: 'Есть неоплаченный счёт',
        unpaidText: 'Оплатите счёт, чтобы избежать приостановки доступа.',
        goToBilling: 'Перейти к оплате',
        allPaidTitle: 'Все счета оплачены',
        allPaidText: 'Спасибо! Ваш доступ активен, беспокоиться не о чем.',
        quickTitle: 'Быстрые действия',
        actionSupport: 'Написать в поддержку',
        actionUpgrade: 'Сменить тариф',
        actionAddUser: 'Добавить пользователя',
      },
      databases: {
        title: 'Мои базы 1С',
        subtitle: 'Базы, размещённые на нашем облачном сервере.',
        empty: 'Пока нет ни одной базы. Оставьте заявку, и мы перенесём её.',
        config: 'Конфигурация',
        users: 'Пользователи',
        size: 'Размер',
        server: 'Сервер',
        connectTitle: 'Данные для подключения',
        protocol: 'Протокол',
      ...
      billing: {
        title: 'Счета',
        subtitle: 'История и текущее состояние оплат. Оплата по банковским реквизитам.',
        number: 'Счёт №',
        period: 'Период',
        amount: 'Сумма',
        statusCol: 'Статус',
        ...
        requisitesNote:
          'Оплатите счёт банковским переводом по реквизитам ниже. В назначении платежа укажите номер счёта. После поступления оплаты статус обновится автоматически.',
        purpose: 'Назначение платежа',
        purposeValue: 'Оплата по счёту',
        close: 'Закрыть',
        copyAll: 'Скопировать реквизиты',
      },
      profile: {
        title: 'Профиль',
        subtitle: 'Данные вашей компании и текущий тариф.',
        company: 'Компания',
        ...
        note: 'Чтобы изменить данные компании, напишите в поддержку.',
      },
    },
    langName: 'UZ',
  },
  ...
  uz: {
    ...
    cabinet: {
      brand: 'Shaxsiy kabinet',
      nav: {
        dashboard: 'Umumiy',
        databases: '1C bazalarim',
        billing: 'Hisoblar',
        profile: 'Profil',
        logout: 'Chiqish',
        site: 'Saytga',
      ...
      login: {
        ...
        subtitle: '1C bazalaringiz, tarif va hisoblaringizni boshqaring.',
        email: 'E-mail',
        password: 'Parol',
        submit: 'Kirish',
        sending: 'Kirilmoqda…',
        error: 'E-mail yoki parol notoʻgʻri.',
        demoHint: 'Demo kirish:',
      ...
      dashboard: {
        ...
        subtitle: '1C bulutingiz boʻyicha qisqacha maʼlumot.',
        subscription: 'Obuna',
        tariff: 'Tarif',
        nextPayment: 'Keyingi toʻlov',
        databases: '1C bazalari',
        users: 'Foydalanuvchilar',
        storage: 'Xotira',
        unpaidTitle: 'Toʻlanmagan hisob bor',
        unpaidText: 'Kirish toʻxtatilmasligi uchun hisobni toʻlang.',
        goToBilling: 'Toʻlovga oʻtish',
        allPaidTitle: 'Barcha hisoblar toʻlangan',
        allPaidText: 'Rahmat! Kirishingiz faol, tashvishlanmang.',
        quickTitle: 'Tezkor amallar',
        actionSupport: 'Yordamga yozish',
        actionUpgrade: 'Tarifni oʻzgartirish',
        actionAddUser: 'Foydalanuvchi qoʻshish',
      },
      databases: {
        title: '1C bazalarim',
        subtitle: 'Bulut serverimizda joylashtirilgan bazalar.',
        empty: 'Hozircha baza yoʻq. Soʻrov qoldiring — biz koʻchiramiz.',
        config: 'Konfiguratsiya',
        users: 'Foydalanuvchilar',
        size: 'Hajmi',
        server: 'Server',
        connectTitle: 'Ulanish maʼlumotlari',
        protocol: 'Protokol',
        address: 'Server manzili',
        copy: 'Nusxalash',
        copied: 'Nusxalandi',
      },
      billing: {
        title: 'Hisoblar',
        subtitle: 'Toʻlovlar tarixi va joriy holati. Bank rekvizitlari orqali toʻlov.',
        number: 'Hisob №',
        period: 'Davr',
        amount: 'Summa',
        statusCol: 'Holat',
        ...
        pay: 'Toʻlash',
        details: 'Rekvizitlar',
        empty: 'Hozircha hisoblar yoʻq.',
        requisitesTitle: 'Toʻlov uchun rekvizitlar',
        requisitesNote:
          'Hisobni quyidagi rekvizitlar boʻyicha bank oʻtkazmasi orqali toʻlang. Toʻlov maqsadida hisob raqamini koʻrsating. Toʻlov kelib tushgach, holat avtomatik yangilanadi.',
        purpose: 'Toʻlov maqsadi',
        purposeValue: 'Hisob boʻyicha toʻlov',
        close: 'Yopish',
        copyAll: 'Rekvizitlarni nusxalash',
      },
      profile: {
        title: 'Profil',
        subtitle: 'Kompaniyangiz maʼlumotlari va joriy tarif.',
        company: 'Kompaniya',
        contact: 'Aloqa shaxsi',
        phone: 'Telefon',
        email: 'E-mail',
        tariff: 'Joriy tarif',
        memberSince: 'Mijoz sanasi',
        changeTariff: 'Tarifni oʻzgartirish',
        note: 'Kompaniya maʼlumotlarini oʻzgartirish uchun yordamga yozing.',
      },
    },
    langName: 'RU',
  },
